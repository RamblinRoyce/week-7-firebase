...
$("#addTrainBtn").on("click", function(){
	...
	var trainRole = $("#roleInput").val().trim();
...
trainData.on("child_added", function(childSnapshot, prevChildKey){
	...
	$("#trainTable > tbody").append("<tr><td>" + trainName + "</td><td>" + trainRole + "</td><td>" + trainStartPretty + "</td><td>" + TrainMonths + "</td><td>" + empRate + "</td><td>" + empBilled + "</td></tr>");
